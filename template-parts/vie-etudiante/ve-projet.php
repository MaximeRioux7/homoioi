<?php 
    ...
    if(have_posts()){                           // N'afficher la section que si des articles sont trouvés
        ...
        while ( have_posts() ) : the_post();    // Boucle s'effectuant pour chaque article
            ...
            <!-- Intégrer le HTML ici --><div class="projet-enfants">
            <a href="#projet-lightb-<?php $i; ?>">
                <img src="<?php echo get_the_post_thumbnail_url(get_the_ID()); ?>" alt="" class="gallerie-img-etudiante img-<?php $i; ?>">
            </a>
        </div>
        <a href="#_" class="lightbox" id="projet-lightb-<?php $i; ?>">
